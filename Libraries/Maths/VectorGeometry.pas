...
type
  ...
  public
    ...
    /// <summary>Creates a new TVector2 object with the specified Components</summary>
    constructor Create(X, Y: Single); overload;
    /// <summary>Creates a new TVector2 object with both Components being the same, given Value</summary>
    constructor Create(V: Single); overload;

    /// <summary>Creates a Vector, with each component being between a random value between 0 and +1</summary>
    class function Random: TVector2; static;
    /// <summary>Creates a Vector, with each component being between a random value between -1 and +1</summary>
    class function RandomBox: TVector2; static;
    /// <summary>Creates normalized Vector, pointing into a random direction</summary>
    /// <remarks>Each point on the resulting circle has the same chance</remarks>
    ...
    /// <summary>Returns a Vector with the same Direction but a Length of 1</summary>
    ...
    /// <summary>Gives a Vector, pointing from the calling to the specified Vector</summary>
    function VectorTo(const A: TVector2): TVector2;

    /// <summary>Rotates the Vector by 90° counter-clockwise</summary>
    ...
    /// <summary>Calculates the Dot-Product with the Vector itself</summary>
    function SqrDot: Single;

    /// <summary>Returns the cosine of the Angle between the calling and another Vector</summary>
    function CosAngleTo(const A: TVector2): Single;
    /// <summary>Returns the Angle between the calling and another Vector in radians</summary>
    ...
    /// <summary>Returns the Angle between the calling and another Vector in degrees</summary>
    function AngleTo(const A: TVector2): Single; inline;
    /// <summary>Rotates the Vector counter-clockwise by the specified Angle in radians</summary>
    function RotateRad(Angle: Single): TVector2;
    /// <summary>Rotates the Vector counter-clockwise by the specified Angle in degrees</summary>
  ...
  public
    ...
    /// <summary>Creates a new TVector3 object with the specified Components</summary>
    constructor Create(X, Y, Z: Single); overload;
    /// <summary>Creates a new TVector3 object with all Components being the same, given Value</summary>
    constructor Create(V: Single); overload;
    ...
    /// <summary>Creates normalized Vector, pointing into a random direction</summary>
    /// <remarks>Each point on the resulting sphere has the same chance</remarks>
    ...
    /// <summary>Rotates the Vector around the specified Vector with the given Angle in radians</summary>
    /// <remarks>
    /// If the specified Vector points towards you, the rotation is counter-clockwise.<para/>
    /// WARNING: The given Vector must be normalized!
    /// </remarks>
    function RotateRad(const A: TVector3; Angle: Single): TVector3;
    /// <summary>Rotates the Vector around the specified Vector with the given Angle in degrees</summary>
    /// <remarks>
    /// If the specified Vector points towards you, the rotation is counter-clockwise.<para/>
    /// WARNING: The given Vector must be normalized!
    /// </remarks>
    function Rotate(const A: TVector3; Angle: Single): TVector3;
    /// <summary>Mirrors the Vector on a Plane, defined by the given Normal</summary>
  ...
  { TVector4 }
  /// <summary>A four Component Vector of Type Single</summary>
  TVector4 = record
  public
    /// <summary>The X-Component of the Vector</summary>
    X: Single;
  ...
  TTrianglePoints = array [TTriangleSide] of TVector2;

  { TBounds1 }
  /// <summary>
  /// Represents 1-Dimensional bounds using two Singles
  /// <para>Shorthand constructor using: <see cref="VectorGeometry|FRange1"/></para>
  /// </summary>
  /// <remarks>
  ...
  public
    ...
    /// <remarks>For inverse operation see <see cref="VectorGeometry|TBounds1.InvPoint"/></remarks>
  ...
  { TBounds2 }
  /// <summary>
  /// Represents 2-Dimensional bounds using two Singles
  /// <para>Shorthand constructor using: <see cref="VectorGeometry|FRange2"/></para>
  /// </summary>
  /// <remarks>
  /// For better performance, most functions assume, that the bounds are normalized (C1 &lt;= C2)
  /// </remarks>
  TBounds2 = record
  public type
    TCorners = array [0 .. 3] of TVector2;
...
/// <summary>Shorthand constructor for TVector2(X, Y)</summary>
function Vec2(X, Y: Single): TVector2; overload; inline;
/// <summary>Shorthand constructor for TVector2(V, V)</summary>
function Vec2(V: Single): TVector2; overload; inline;
/// <summary>Shorthand constructor for TVector3(X, Y, Z)</summary>
function Vec3(X, Y, Z: Single): TVector3; overload; inline;
/// <summary>Shorthand constructor for TVector3(V, V, V)</summary>
function Vec3(V: Single): TVector3; overload; inline;

/// <summary>Shorthand constructor for TBounds1(A, B)</summary>
function FRange1(A, B: Single): TBounds1; overload; inline;
/// <summary>Shorthand constructor for TBounds1(0, A)</summary>
function FRange1(A: Single): TBounds1; overload; inline;

/// <summary>Shorthand constructor for TBounds2(A, B)</summary>
function FRange2(A, B: TVector2): TBounds2; overload; inline;
/// <summary>Shorthand constructor for TBounds2(0, A)</summary>
function FRange2(A: TVector2): TBounds2; overload; inline;

/// <summary>Shorthand constructor for TBounds3(A, B)</summary>
...
function TVector2.RotateRad(Angle: Single): TVector2;
begin
  Result := Sin(Angle) * Cross + Cos(Angle) * Self;
end;

function TVector2.Rotate(Angle: Single): TVector2;
begin
  Result := RotateRad(DegToRad(Angle));
end;
